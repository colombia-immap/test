...
with open('../../power bi data/FB_AU_Colombian_Cities_v3.csv', 'r') as csvfile_1:
	new_rows=[]
	...
	for a in data:
		...
		if a[3]=='':
			...
			with open('../dataCOL_expats/dataframe_collected_finished_cities_dec31.csv','r')as csvfile_2:
...
with open('../../power bi data/FB_AU_Colombian_Cities_v3.csv', 'w', newline='') as f:
