...
with open('../FB_AU_Colombian_Cities_FORO.csv','r') as csvfile_1:
	new_rows=[]
	...
	for a in data:
		new_a=a
		if a[0]=='DEPARTAMENTO':
			new_a.extend(['mau_dec','dau_dec','indicador_presion_dec'])
		...
		if a[3]=='':
			...
			with open('../dataCOL_expats/dataframe_collected_finished_foro_dec.csv','r')as csvfile_2:
...
with open('../FB_AU_Colombian_Cities_FORO.csv','w',newline='')as f:
	#Overwritetheoldfilewiththemodifiedrows
	writer=csv.writer(f)
