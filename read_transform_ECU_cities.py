...
with open('../FB_AU_Ecuatorian_Cities.csv', 'r') as csvfile_1:
    new_rows=[]
    ...
    for a in data:
        new_a = a
        if a[0] == 'DEPARTAMENTO':
            new_a.extend(['venezuelan_mau_dec31', 'venezuelan_dau_dec31', 'indicador_presion_dec31'])
...
with open('../FB_AU_Ecuatorian_Cities.csv', 'w',newline='') as f:
