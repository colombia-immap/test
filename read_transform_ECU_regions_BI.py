...
with open('../../power bi data/FB_AU_Ecuador_regions.csv', 'r') as csvfile_1:
    new_rows=[]
    ...
    for a in data:
        ...
        if a[2] == '':
            ...
            with open('../dataECU_expats/dataframe_collected_finished_ecu_dec31.csv', 'r') as csvfile_2:
                ...
                for b in collected:
                    if b[11] != 'geo_locations':
                        chunk = b[26]
                        tojson = chunk.split("'")
                        if a[0] != 'admin1' and a[0] != '#adm1+name':
                            if a[2] == tojson[5]:
                                d = b[44]
                                ml = b[46]
                                mu = b[47]
...
with open('../../power bi data/FB_AU_Ecuador_regions.csv', 'w',newline='') as f:
