...
with open('../../power bi data/FB_AU_Peru_regions.csv', 'r') as csvfile_1:
    new_rows=[]
    ...
    for a in data:
        ...
        if a[0] == '':
            ...
            with open('../dataPER_expats/dataframe_collected_finished_peru_dec31.csv', 'r') as csvfile_2:
...
with open('../../power bi data/FB_AU_Peru_regions.csv', 'w',newline='') as f:
